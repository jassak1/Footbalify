...
struct SettingsView: View {
    ...
    var aboutView: some View {
        ScrollView(.vertical) {
            Text("Footbalify is the ultimate app for NFL enthusiasts, offering comprehensive access to the latest schedules and standings. It provides up to date game details, including dates and times, making it easy to stay updated on all the action. Users can effortlessly track their favorite teams' performance with up-to-date standings for all NFL divisions and conferences. \n\nThe app also features customizable Widgets for both Home Screen and Lock Screen, offering at-a-glance information on upcoming games and current standings. With a sleek and user-friendly interface, Footbalify ensures navigating through NFL schedules and standings is a seamless experience.\n\nFootbalify is designed to enhance the overall NFL experience, providing quick, reliable updates and ensuring fans never miss a moment of their favorite sport.")
        }.scrollIndicators(.hidden)
